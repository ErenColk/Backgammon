...
const BlackPiece4 = () => {
  ...
  const changeTriangleColor = (e, startOrFinished) => {
    ...
    console.log(
      "🚀 ~ changeTriangleColor ~  parseInt(dice2, 10):",
      parseInt(dice2, 10)
    );
    console.log(
      "🚀 ~ changeTriangleColor ~ parseInt(dice1, 10):",
      parseInt(dice1, 10)
    );
    console.log(
      "🚀 ~ changeTriangleColor ~  parseInt(parentId, 10):",
      parseInt(parentId, 10)
    );

    console.log(
      "🚀 ~ changeTriangleColor ~ parseInt(dice2, 10) - parseInt(parentId, 10):",
      parseInt(parentId, 10) - parseInt(dice2, 10)
    );
    console.log(
      "🚀 ~ changeTriangleColor ~ parseInt(dice1, 10) - parseInt(parentId, 10):",
      parseInt(parentId, 10) - parseInt(dice1, 10)
    );
